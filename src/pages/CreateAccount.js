...
const CreateAccount = () => {
  return (
    <div className='w-[80%] md:w-[40%] md:p-10 mx-auto flex flex-col items-center mt-5' >
      <h1 className='text-2xl md:text-3xl font-bold mb-10'>Welcome to Blog Verse</h1>
      ...
      <p>Already have an account? <Link to="/auth/signin" ><button className='text-indigo-600'>Log in</button></Link></p>
    </div>
  )
}
